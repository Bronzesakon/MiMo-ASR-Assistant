      ...
      <div class="panel">
        ...
        <div class="panel-body">
          ...
          <div class="field">
            ...
            <select v-model="store.apiConfig.provider" class="select" @change="onProvider">
          ...
          <div class="field">
            ...
            <select v-model="store.apiConfig.polishModel" class="select" @change="store.saveConfig()">
              <option v-for="m in prov.chat" :key="m" :value="m">{{ m }}</option>
            </select>
          </div>
          ...
          <div class="field">
            ...
            <div class="field-hint">留空使用默认提示词。修改后自动保存。</div>
          </div>
        </div>
      </div>
    </div>
